...
import SiloSvg from ".../public/silo.svg";  // Ruta al SVG del Silo
import ConveyorSvg from ".../public/conveyor.svg";  // Ruta al SVG del Conveyor
import MillSvg from ".../public/mill.svg";  // Ruta al SVG del Molino
